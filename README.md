...
- Arquitectura de un pipeline determinista para generar sitios web, de la investigación al deploy.
- Automatización de flujos con Python, PowerShell y n8n.
- Documentación como fuente de verdad, usando Git y Markdown en vez de conocimiento disperso.

## Stack

<p align="center">
  <img src="https://skillicons.dev/icons?i=py,js,html,css,docker,git,github,powershell,obsidian,md" />
</p>
